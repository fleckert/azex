...
test('devops_permissions_token-classificationNodes', async () => {
    ...
    const pathOut      = path.join(__dirname, 'out', `devops_permissions_token-classificationNodes`);
...
test('devops_permissions_token-gitRepositories', async () => {
    ...
    const projectName  = config.azureDevOps.projectName;
    const tenantId     = config.azureDevOps.tenantId;
    const pathOut      = path.join(__dirname, 'out', `devops_permissions_token-gitRepositories`);
...
test('devops_permissions_token-all', async () => {
    ...
    const projectName  = config.azureDevOps.projectName;
    const tenantId     = config.azureDevOps.tenantId;
    const pathOut      = path.join(__dirname, 'out', `devops_permissions_token-all`);
