...
test('devops_permissions_token-environment'                     , async () => { await runtest           ('environment'         , devops_permissions_token.environment         ) }, 100000);
...
test('devops_permissions_token-allProjects_environment'         , async () => { await runtestAllProjects('environment'         , devops_permissions_token.environment         ) }, 100000);
