...
export class ItemAndOthers {
    constructor(
        readonly item: GraphMember,
        readonly others: Array<ItemAndOthers>
    ) { }
    ...
    private getFlatDown(items: Array<ItemAndOthers>): Array<{ member: GraphMember; container: GraphMember; }> {
        const map = new Map<string, { member: GraphMember; container: GraphMember; }>();
    ...
    private getFlatUp(items: Array<ItemAndOthers>): Array<{ member: GraphMember; container: GraphMember; }> {
        const map = new Map<string, { member: GraphMember; container: GraphMember; }>();
