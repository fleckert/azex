...
export class AzureDevOpsPortalLinks {
    ...
    static PermissionsOrganizationSubject(organization: string, subjectDescriptor: string) { return `https://dev.azure.com/${organization}/_settings/groups?subjectDescriptor=${subjectDescriptor}` }
}
