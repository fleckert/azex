...
export class BearerToken {
    static azureDevOps    (tenantId: string | undefined): Promise<string> { return this.get('499b84ac-1321-427f-aa17-267ca6975798', tenantId); }
    static azureManagement(tenantId: string | undefined): Promise<string> { return this.get('https://management.core.windows.net' , tenantId); }
    static microsoftGraph (tenantId: string | undefined): Promise<string> { return this.get('https://graph.microsoft.com'         , tenantId); }
